...
.method private constructor <init>(Landroid/net/fourG/wimax/Wimax4GManager;ILjava/lang/String;)V
    ...
    .line 1138
    iput-object p3, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mTag:Ljava/lang/String;

    .line 1139
    iput p2, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mLockType:I
    ...
    .line 1141
    iput v1, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCount:I

    .line 1142
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCounted:Z

    .line 1143
    iput-boolean v1, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mHeld:Z
...
.method public acquire()V
    ...
    .line 1159
    :try_start_3
    iget-boolean v0, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCounted:Z

    if-eqz v0, :cond_3f

    iget v0, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCount:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCount:I
    :try_end_d
    ...
    iget v3, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mLockType:I

    iget-object v4, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mTag:Ljava/lang/String;
    ...
    :try_start_3b
    iput-boolean v0, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mHeld:Z
    ...
    .line 1159
    :cond_3f
    iget-boolean v0, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mHeld:Z
    :try_end_41
...
.method public release()V
    ...
    iget-object v3, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mTag:Ljava/lang/String;
...
.method public setReferenceCounted(Z)V
    ...
    .prologue
    .line 1219
    iput-boolean p1, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCounted:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v3, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mHeld:Z
    ...
    :goto_11
    iget-boolean v3, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCounted:Z
    ...
    iget v5, p0, Landroid/net/fourG/wimax/Wimax4GManager$Lock;->mRefCount:I
